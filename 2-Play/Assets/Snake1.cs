...
public class Snake1 : MonoBehaviour
{
    ...
    {
        if(dir == 0 && _direction != Vector2.down)
            _direction = Vector2.up;
        else if(dir == 1 && _direction != Vector2.up)
            _direction = Vector2.down;
        else if(dir == 2 && _direction != Vector2.right)
            _direction = Vector2.left;
        else if(dir == 3 && _direction != Vector2.left)
